...
export const articles = [
  {
    ...
    readTime: 8,
    tags: ['TikTok', '广告', '入门'],
    excerpt: '从账户类型、开户步骤到 Pixel 安装，带你建立第一套 TikTok 广告基础认知。'
  },
  {
    slug: 'ads-basics',
    section: 'tiktok-marketing',
    ...
    excerpt: '系统梳理 Campaign / Ad Group / Ad 架构、定向方式、出价逻辑与创意优化。'
  },
  {
    ...
    excerpt: '从成本、自由度、可维护性和增长阶段四个维度，对比两套主流独立站方案。'
  },
  {
    slug: 'seo-guide',
    section: 'independent-store',
    ...
    excerpt: '从技术 SEO 到内容策略，整理一套适合跨境独立站的搜索优化实践。'
  },
  {
    slug: 'vps-selection',
    section: 'networking',
    ...
    readTime: 10,
    tags: ['VPS', '服务器', '建站'],
    excerpt: '对比主流 VPS 厂商、配置规格与适用场景，帮你少踩坑地选到合适机器。'
  },
  {
    ...
    excerpt: '从 Certbot 安装、Nginx 配置到自动续期，快速完成 HTTPS 上线。'
  }
]
